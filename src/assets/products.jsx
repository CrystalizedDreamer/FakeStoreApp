    ...
    <div className="container my-4">
      ...
      <div className="row">
        {products.map(product => (
          <div className="col-12 col-sm-6 col-md-3 mb-4 mt-4 pt-2 pb-2" key={product.id}>
            <div className="card h-100" id="productCard">
              ...
              <div className="cardBody">
                ...
                <p className="card-text" style={{fontSize: '0.9em'}}>{product.description.substring(0, 80)}...</p>
    ...
    setEditForm({
      ...
      image: product.image
                ...
                <button
                    ...
                    onClick={() => setModalProduct(product)}>Details
                </button>
          ...
          <div className="modal-dialog modal-dialog-centered">
            <div className="modal-content">
              ...
              <div className="modal-body text-center">
                <img src={modalProduct.image} alt={modalProduct.title} style={{maxHeight: '200px', objectFit: 'contain'}} className="mb-3"/>
                <p><strong>Price:</strong> ${modalProduct.price}</p>
                <p><strong>Category:</strong> {modalProduct.category}</p>
                <p>{modalProduct.description}</p>
              </div>
              <div className="modal-footer">
                <button className="btn btn-secondary" onClick={() => setModalProduct(null)}>
                  Close
                </button>
              </div>
            </div>
        ...
        >
          ...
          <div className="modal-body">
            ...
            <div className="mb-3">
              ...
              <input type="number" className="form-control" value={editForm.price} onChange={e => setEditForm(f => ({...f, price: e.target.value}))} step="0.01" />
            </div>
            <div className="mb-3">
              <label className="form-label">Category</label>
              <input className="form-control" value={editForm.category} onChange={e => setEditForm(f => ({...f, category: e.target.value}))} />
            </div>
            <div className="mb-3">
            ...
            <div className="mb-3">
              ...
              <input className="form-control" value={editForm.image} onChange={e => setEditForm(f => ({...f, image: e.target.value}))} />
            </div>
          </div>
          <div className="modal-footer">
            <button type="button" className="btn btn-danger me-auto" onClick={() => setShowDeleteConfirm(true)}>
              Delete
            </button>
            ...
            <div className="modal-content">
              ...
              <div className="modal-footer">
                ...
                <button type="button" className="btn btn-danger" onClick={async () => {
                  try {
                    await fetch(`https://fakestoreapi.com/products/${editProduct.id}`, { method: 'DELETE' });
